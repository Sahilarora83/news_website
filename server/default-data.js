export function createDefaultStoreData() {
  ...
  const categories = [
    ...
    { id: 6, name: 'उत्तर प्रदेश', slug: 'uttar-pradesh-news', sortOrder: 6 },
    { id: 7, name: 'दिल्ली', slug: 'delhi-news', sortOrder: 7 },
    { id: 8, name: 'बिहार', slug: 'bihar-news', sortOrder: 8 },
    { id: 9, name: 'टेक', slug: 'tech', sortOrder: 9 },
    { id: 10, name: 'मनोरंजन', slug: 'entertainment', sortOrder: 10 },
  ];
  ...
  return {
    ...
    electionTabs: [],
    epaperEditions: [
      { name: 'Delhi', slug: 'delhi-city', edition: 'Main', date: '06 Apr, 2026', pages: 16, image: '/epaper/delhi-main.jpg' },
      { name: 'Lucknow city', slug: 'lucknow-city', edition: 'Main', date: '06 Apr, 2026', pages: 12, image: '/epaper/lucknow-main.jpg' },
      { name: 'Agra city', slug: 'agra-city', edition: 'Main', date: '06 Apr, 2026', pages: 10, image: '/epaper/agra-main.jpg' },
      { name: 'Dehradun city', slug: 'dehradun-city', edition: 'Main', date: '06 Apr, 2026', pages: 10, image: '/epaper/dehradun-main.jpg' },
      { name: 'Shimla', slug: 'shimla', edition: 'Main', date: '06 Apr, 2026', pages: 8, image: '/epaper/shimla-main.jpg' },
      { name: 'Gorakhpur city', slug: 'gorakhpur-city', edition: 'Main', date: '06 Apr, 2026', pages: 10, image: '/epaper/gorakhpur-main.jpg' },
    ],
    epaperMagazines: [
      { name: 'E-Manoranjan', slug: 'emanoranjan', image: '/epaper/emanoranjan.jpg' },
      { name: 'Udan', slug: 'udan', image: '/epaper/udan.jpg' },
      { name: 'Rupayan', slug: 'rupayan', image: '/epaper/rupayan.jpg' },
    ],
    slotDefinitions,
